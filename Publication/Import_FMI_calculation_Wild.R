...
#The purpose of this script is to calculate import FMI values accounting for 
#re-exports using the wild capture data

#Use proportional method of imports v production for trade partners
...
write.csv(FMIi, "ConsumptionAngle/Import_FMI_prop_Wild.csv")
