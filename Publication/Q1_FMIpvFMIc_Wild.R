...
#question of the Trade Analysis using the wild capture data.
...
p1# png(#filename="ConsumptionAngle/Figures/1_FMIdiff.png", 
...
#   filename="ConsumptionAngle/Figures/2_FMIcComp_prop_Wild.png",
#   units="in",
#     width=10,
#     height=8,
#     pointsize=15,
...
select(d2, Country, FMIp, meanFMIc, perc_diff) %>% arrange(desc(FMIp))
...
d5c$IO <- factor(d5c$IO, 
                 levels = c("United StatesOutput", "United StatesInput",
                            ...
                            "New ZealandOutput", "New ZealandInput",
                            "New Zealandgap",
                            ...
                            "South AfricaOutput", "South AfricaInput", "South Africagap",
...
p4a <- ggplot() +
  ...
  scale_fill_manual(breaks = c("Exports", "Imports", "Production"),
                    values = c("gray40", "deepskyblue4", "deepskyblue3", "white")) +
...
p5 <- ggplot() +
  ...
  geom_errorbarh(data = bars, aes(xmin = min,
                                  ...
                                  y = Country),
                 alpha = 0.5, height = 0) +
  geom_hline(yintercept = 7.5, linetype = "longdash") +
...
png(filename="ConsumptionAngle/Figures/2_Top25RawDiff_Flow1_Wild.png",
    width=4500,
    height = 3000,
    res=300)
...
# png(filename="ConsumptionAngle/Figures/2_Top25RawDiff_Flow2_Wild.png",
#     width = 4500,
#     height = 3000,
#     res=300)
# 
