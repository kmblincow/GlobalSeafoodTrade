...
#The purpose of this script is to generate the US import map figure with wild capture data
...
sum(US2$propI) #represents 94.34% of US imports
...
png(filename="ConsumptionAngle/Figures/USImportsMap5_USCentered_Top25_Wild.png", 
    units="in", 
    width=15, 
    height=10, 
    pointsize=15, 
