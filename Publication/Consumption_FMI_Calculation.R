...
#FAO data and calculate the consumption FMI
...
impFMI <- read.csv("ConsumptionAngle/Import_FMI_prop.csv", header = T)
...
#proportional assumption
write.csv(d2, "ConsumptionAngle/Final_FAOFMI_prop.csv")
