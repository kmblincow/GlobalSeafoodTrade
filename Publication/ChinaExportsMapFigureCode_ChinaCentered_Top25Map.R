...
#The purpose of this script is to generate the China export map figure
...
sum(Ch2$propE) #accounts for 88.98% of total exports
...
png(filename="ConsumptionAngle/Figures/ChExportsMap3_ChinaCentered_Top25Map.png", 
    units="in", 
    width=15, 
    height=10, 
    pointsize=15, 
